...
-- coping all files of delta folder custaddress
...
-- CHECK RECORDS IN THE STAGE SCH STM
--                            RUN THE ABOVE MERGE STATEMENTS
-- SCD 1 AND TRACKCHANGES IN THR CLEAN STM
-- SCD 2 ADN TRACK RECORD IN FINAL DIMENTION TABLE
